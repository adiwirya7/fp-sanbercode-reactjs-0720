    ...
    return(
        <Paper >
            ...
            <Grid container>
                ...
                <Grid item md={12} lg={12} xs={12} className={classes.mainFeaturedPost} style={{ backgroundImage: `url()`, backgroundColor:'#3f51b5' }}>
                    {<img style={{display: "inline" ,float:"left", width:300,height:460, margin: 30}} src={movie.image_url} />}
