    ...
    return(
        <Paper >
            ...
            <Grid container>
                ...
                <Grid item md={12} lg={12} xs={12} className={classes.mainFeaturedPost} style={{ backgroundImage: `url()` }}>
                {<img style={{display: "inline" ,float:"left", width:300,height:460, margin: 30}} src={game.image_url} />}
